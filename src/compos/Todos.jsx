    ...
    <>
      <div className=" h-full w-full flex items-center justify-between flex-col z-[2]">
        <div className=" select-none h-[20vh]  w-full flex flex-col items-center justify-center">
          ...
          <div className="flex items-center justify-between px-[5%] w-full">
            ...
            <div className=" text-white text-[2rem] flex items-center justify-center ">
              <button className="flex items-center justify-center" onClick={arrangefun}><span className=" text-[1.1rem] p-2 rounded-full hover:bg-white hover:text-black material-symbols-outlined max-sm:active:bg-neutral-400 max-sm:bg-white max-sm:text-black">grid_view</span></button>
            </div>
        ...
        <div className=" h-[80vh] w-full" ref={refer}>
          {arrtodos.length != 0 ? (
            <div style={{ scrollbarWidth: "none" }} className={`flex items-start flex-wrap justify-start gap-4 relative  px-10 py-6  w-full h-full  overflow-y-scroll max-sm:px-0 max-sm:gap-0 `} >
              {arrtodos?.map((e) => (
