...
const Todocard = ({info, reference}) => {
  ...
  return (
    ...
    className=" select-none bg-opacity-70 backdrop-blur-[2px] bg-black-400 border-[1px] border-white rounded p-1 opacity-100  overflow-hidden text-white w-[15rem] h-[15rem] bg-black relative max-sm:w-[45%] max-sm:h-1/3">
